        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                entity.HasData(
                    ...
                    new Employee
                    {
                        Id = Guid.Parse("7c30c0cd-f8df-48b4-9eba-8c56c7c185c8"),
                        Name = "Đỗ Trần Tuấn Anh",
                        Gender = "Nam",
                        Username = "adminS",
                        Email = "adminS@gmail.com",
                        Password = "tuananh",
                        PhoneNumber = "0256478983",
                        Dob = new DateOnly(2004, 1, 1),
                        RoleId = "Admin",
                        BranchId = null,
                    },
                    new Employee
                    {
                        Id = Guid.Parse("94bf05f6-e5ff-45c6-8174-c4920edce47f"),
                        Name = "Lê Hồng Anh",
                        Gender = "Nam",
                        Username = "adminC",
                        Email = "adminC@gmail.com",
                        Password = "lehonganh",
                        PhoneNumber = "0154789324",
                        Dob = new DateOnly(2004, 7, 7),
                        RoleId = "Admin",
                        BranchId = null,
                    });
            });
            ...
            modelBuilder.Entity<Address>( entity =>
            {
                ...
                //Admin Nam
                    new Address
                    {
                        Id = Guid.Parse("a4e84922-0b61-4031-93ba-b074e85f7197"),
                        EmployeeId = Guid.Parse("7c30c0cd-f8df-48b4-9eba-8c56c7c185c8"),
                        DistrictId = Guid.Parse("53b0b29e-7b2c-4d4b-accc-f693ce746539"),
                        Street = "Miền Nam, HCM, Q1",
                        IsDefault = true,
                    },
                //Admin Trung
                    new Address
                    {
                        Id = Guid.Parse("e296a8c8-fdb9-4009-b6ff-ba8e1e2a7a3c"),
                        EmployeeId = Guid.Parse("94bf05f6-e5ff-45c6-8174-c4920edce47f"),
                        DistrictId = Guid.Parse("9fc84eab-708a-49a2-b819-06d0629e560a"),
                        Street = "Miền Trung, Đà Nẵng, Hoàng Sa",
                        IsDefault = true,
                    });
            });
        }
