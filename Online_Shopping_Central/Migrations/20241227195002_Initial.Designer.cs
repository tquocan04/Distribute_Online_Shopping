...
namespace Online_Shopping_Central.Migrations
{
    ...
    [Migration("20241227195002_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e296a8c8-fdb9-4009-b6ff-ba8e1e2a7a3c"),
                            DistrictId = new Guid("9fc84eab-708a-49a2-b819-06d0629e560a"),
                            EmployeeId = new Guid("94bf05f6-e5ff-45c6-8174-c4920edce47f"),
                            IsDefault = true,
                            Street = "Miền Trung, Đà Nẵng, Hoàng Sa"
                        });
                });

            modelBuilder.Entity("Online_Shopping_Central.Entities.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.BranchProduct", b =>
                {
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Credential", b =>
                {
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("94bf05f6-e5ff-45c6-8174-c4920edce47f"),
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Item", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Payment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Region", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.ShippingMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Address", b =>
                {
                    b.HasOne("Online_Shopping_Central.Entities.Branch", "Branch")
                        .WithMany("Addresses")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Online_Shopping_Central.Entities.Customer", "Customer")
                        .WithMany("Addresses")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Online_Shopping_Central.Entities.District", "District")
                        .WithMany("Addresses")
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Online_Shopping_Central.Entities.Employee", "Employee")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.BranchProduct", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_Central.Entities.Product", "Product")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.City", b =>
                {
                    b.HasOne("Online_Shopping_Central.Entities.Region", "Region")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.District", b =>
                {
                    b.HasOne("Online_Shopping_Central.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_Central.Entities.Role", "Role")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Item", b =>
                {
                    b.HasOne("Online_Shopping_Central.Entities.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_Central.Entities.Payment", "Payment")
                        .WithMany("Orders")
                        .HasForeignKey("PaymentId");

                    b.HasOne("Online_Shopping_Central.Entities.ShippingMethod", "ShippingMethod")
                        .WithMany("Oders")
                        .HasForeignKey("ShippingMethodId");

                    b.HasOne("Online_Shopping_Central.Entities.Voucher", "Voucher")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Online_Shopping_Central.Entities.Product", b =>
                {
                    b.HasOne("Online_Shopping_Central.Entities.Category", "Category")
                        .WithMany("Products")
