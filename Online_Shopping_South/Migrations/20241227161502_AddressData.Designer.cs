...
namespace Online_Shopping_South.Migrations
{
    ...
    [Migration("20241227161502_AddressData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a4e84922-0b61-4031-93ba-b074e85f7197"),
                            DistrictId = new Guid("53b0b29e-7b2c-4d4b-accc-f693ce746539"),
                            EmployeeId = new Guid("7c30c0cd-f8df-48b4-9eba-8c56c7c185c8"),
                            IsDefault = true,
                            Street = "Miền Nam, HCM, Q1"
                        });
                });

            modelBuilder.Entity("Online_Shopping_South.Entities.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.BranchProduct", b =>
                {
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Credential", b =>
                {
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c30c0cd-f8df-48b4-9eba-8c56c7c185c8"),
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Item", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Payment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Region", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.ShippingMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Address", b =>
                {
                    b.HasOne("Online_Shopping_South.Entities.Branch", "Branch")
                        .WithMany("Addresses")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Online_Shopping_South.Entities.Customer", "Customer")
                        .WithMany("Addresses")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Online_Shopping_South.Entities.District", "District")
                        .WithMany("Addresses")
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Online_Shopping_South.Entities.Employee", "Employee")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.BranchProduct", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_South.Entities.Product", "Product")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.City", b =>
                {
                    b.HasOne("Online_Shopping_South.Entities.Region", "Region")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.District", b =>
                {
                    b.HasOne("Online_Shopping_South.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_South.Entities.Role", "Role")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Item", b =>
                {
                    b.HasOne("Online_Shopping_South.Entities.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Online_Shopping_South.Entities.Payment", "Payment")
                        .WithMany("Orders")
                        .HasForeignKey("PaymentId");

                    b.HasOne("Online_Shopping_South.Entities.ShippingMethod", "ShippingMethod")
                        .WithMany("Oders")
                        .HasForeignKey("ShippingMethodId");

                    b.HasOne("Online_Shopping_South.Entities.Voucher", "Voucher")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Online_Shopping_South.Entities.Product", b =>
                {
                    b.HasOne("Online_Shopping_South.Entities.Category", "Category")
                        .WithMany("Products")
